...
?>/smarthome5/" role="tab" aria-controls="v-pills-home" aria-selected="true"><i class="fas fa-home" style='font-size:17px'></i> Home</a>
      <a class="nav-link active font-weight-bold mb-1" id="v-pills-profile-tab" href="http://<?php
//To Read File
$file = 'C:\xampp\htdocs\ip.txt';
$fp = fopen($file, 'r');
$data = fread($fp,filesize($file));
...
<script type="text/javascript">
  alert('Meload semua data memakan waktu yang cukup lama, tergantung dari jumlah datanya');
</script>
<!---->
<script type="text/javascript">
...
<table id="dataTables" class="display text-white" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th>NO.</th>
                <th>SUHU</th>
...
$data = fread($fp,filesize($file));
echo $data; 
?>/smarthome5/datatables/jquery.dataTables.min.js"></script>
  <script>
