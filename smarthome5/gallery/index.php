...
echo $data; 
?>/smarthome5/datatables/jquery.dataTables.min.css">
...
$data = fread($fp,filesize($file));
echo $data; 
?>/smarthome5/blueimp/css/blueimp-gallery.min.css">
...
body {
  ...
  <body class="bg-dark" style="height: 720px;">
...
$data = fread($fp,filesize($file));
echo $data; 
?>/smarthome5/gallery/" style="background-color: #007bff;">Gallery</a>
  </li>
  <li class="nav-item font-weight-bold">
    <a class="nav-link rounded" href="http://<?php
//To Read File
...
<!---->
<div class="ml-4">
<h3 class="text-white">Menampilkan Gambar Hasil Capture</h3>
<!-- -->
<div id="links" style="height:500px;overflow: scroll;">
  <a href="#" style="width: 75px;height: 75px;border:0;"></a>
  <?php 
...
require_once('conntable.php');
      ...
      while($row = $res->fetch_assoc()){
        ...
        echo '<a href="http://localhost/backend/hasil-capture/'.$row['snap_link'].'" title="'.$row['snap_link'].'">
        <img src="http://localhost/backend/hasil-capture/'.$row['snap_link'].'" alt="'.$row['snap_link'].'" style="width:75px;height:75px;border:0;" class="rounded border border-secondary">
    </a>';
...
$data = fread($fp,filesize($file));
echo $data; 
?>/smarthome5/blueimp/js/blueimp-gallery.min.js"></script>
