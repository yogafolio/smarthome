...
?>/smarthome5/">Home</a></li>
    <li class="breadcrumb-item active" aria-current="page">CCTV</li>
      ...
      <!--awal content-->
      <div class="ml-4">
<img style="-webkit-user-select: none" src="http://192.168.43.201:8081/">

      </div>
      <div class="ml-4 mt-4">
  <div class="text-white" id="pesan"></div>
   <div class="text-white"><p>atau <a href="http://192.168.43.201">Klik disini</a> untuk langsung tanpa menunggu</p></div>
</div>
...
var typed = new Typed('#typed',{
  strings : ['Welcome to CCTV Page','You will be redirect to another page'],
  typeSpeed : 80,
  delaySpeed : 90,
  loop : false
});
